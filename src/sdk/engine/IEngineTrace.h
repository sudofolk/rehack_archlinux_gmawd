...
public:
	...
	{
		//C_BasePlayer* pEnt = reinterpret_cast<C_BasePlayer*>(pEntityHandle);
...
public:
	...
	virtual void	TraceRay(const Ray_t& ray, unsigned int fMask, TraceFilterSimple* pTraceFilter, trace_k* pTrace) = 0;
